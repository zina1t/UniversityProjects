...
| **Portability**                | Возможность использования системы в различных условиях.       | Средняя               | Тестирование в разных условиях   | Баллы (1-10)        | Данные о средах использования, характеристиках  | Уровень портативности, описание условий    | Оценка по результатам тестов            | [IEEE 828](https://ieeexplore.ieee.org/document/4297502) |
